...
- **GitHub repository** - the customer is to be added as a contributor with write access
- **Unity Version Control** - project access to be transferred to the customer
...
GitHub contributor access and Unity Version Control access were requested from the customer but have not been completed as of submission - the customer has not yet provided the required account details. This is a customer-side blocker, not a team-side one.
