...
- **Scenario:** When the system loads the game scene under standard conditions, the `PauseManager` artifact shall ensure the game state is fully unpaused (`Time.timeScale = 1`) within 1 frame.
