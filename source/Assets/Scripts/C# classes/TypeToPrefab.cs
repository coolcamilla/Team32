...
public static class TypeToPrefab
{
    ...
    public static Dictionary<ItemType, GameObject> GetDictionary { 
        get
        {
            if (_typeToPrefab == null) InitializeDictionary();
    ...
    private static void InitializeDictionary()
    {
        ...
        foreach(ItemType type in Enum.GetValues(typeof(ItemType)))
        {
            ...
            //TODO: add chain of responsibility OR change project Hierarchy.
            if (newPrefab == null)
            {
                newPrefab = Resources.Load<GameObject>($"Prefabs/Items/Instruments/{name} Object");
            }
            if (newPrefab == null)
            {
