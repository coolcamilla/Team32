...
5. **Claude** was used to analyze and summarize Sprint Review and UAT session results.
6. **Claude** was used to refine writing style in reports. 
7. **Evernote AI** was used for extracting text from audio recording of the interview.
8. **DeepL** was used for translating interview questions and transcripts to English.
